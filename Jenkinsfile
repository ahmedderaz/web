...
stage("Deploy to Devlopment"){
 ...
 steps {
     ...
     sh '''
     scp -p 2121 -o stricthostkeychecking=no "api_S1.${env.BUILD_NUMBER}.zip" ahmed@192.168.40.165:/home/ahmed/web/
     ssh -P 2121 -o stricthostkeychecking=no "./home/ahmed/web/jenkins_api_script.s ${env.BUILD_NUMBER}"
     '''
         }
            }
