...
when {
 ...
 steps {
     ...
     sh 'scp -p 11210 -o stricthostkeychecking=no "api_S1.${env.BUILD_NUMBER}.zip ahmed@192.168.40.165:/home/ahmed/web/"'
     sh 'ssh -P 11210 -o stricthostkeychecking=no "./home/ahmed/web/jenkins_api_script.s ${env.BUILD_NUMBER}"'
         }
            }
stage("Deploy to UAT"){
when {
