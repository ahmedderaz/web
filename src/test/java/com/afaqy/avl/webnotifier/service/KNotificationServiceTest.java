...
public class KNotificationServiceTest {
    ...
    public static void setUp() throws Exception {
        ...
        service = WebNotifierContext.getInstance().getkNotificationService();
    }

    @Test
    public void startConsumer() {
        service.startConsumer();
        Assert.assertEquals(WebNotifierContext.getInstance().getNotificationConsumerMap().size(), 1);
    }

    @Test
    public void stopRandomConsumer() throws InterruptedException {
        service.stopRandomConsumer();
        Assert.assertEquals(WebNotifierContext.getInstance().getNotificationConsumerMap().size(), 0);
    }
